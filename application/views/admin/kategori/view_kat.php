...
<body>
    ...
    <br><br>
    <form class="form-inline" method="post" action="<?php echo base_url().'kategori/cari'; ?>">
    
    Cari Kategori : <input type="text" class="form-control" id="kategori" placeholder="masukkan nama kategori" name="cari">
    <button type="submit" class="btn btn-default" name="submit">Submit</button>
    <a  href="<?php echo site_url("kategori"); ?>/tambahData" class="btn btn-success">Tambah Data</a>
    </form>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="yellow header headerSortDown">ID Kategori</th>
                <th class="yellow header headerSortDown">Nama Kategori</th>
            ...
            <tbody>
              ...
              foreach($kategori as $row):
                ...
                echo '<td width=90px>'; ?>
                <?php echo anchor('kategori/updateData/'.$row['id_kat'],'Lihat & Edit',array('class' => 'btn btn-info')); ?>
                <?php echo '</td>
                <td width=60px>'; ?>
                <?php echo anchor('kategori/hapusData/'.$row['id_kat'],'Hapus',array('onclick'=>'return confirm(\'Apakah Anda Yakin?\');', 'class' => 'btn btn-danger')); ?>
                <?php echo '</td>';
                echo '</tr>';
              endforeach;
              ?>      
