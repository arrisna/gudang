...
<body>
	...
	<table align="center">
		<tr>
			<td><h2>Tambah Pembelian</h2></td>
		</tr>
	</table><br>

<?php
$attributes = array('class' => 'form-horizontal', 'id' => '');
echo form_open('pembelian/tambah', $attributes); ?>

<fieldset>
          <div class="control-group">
            <label>No Pembelian</label>
            <div class="controls">
              <label><input type="text" id="" name="no_pembelian" placeholder="nomor pembelian" value="<?php echo set_value('no_pembelian'); ?>" ></label>
              <label for="inputError" class="control-label"><?php echo form_error('no_pembelian','<div style="color:red">','</div>'); ?></label>
            </div>
          </div>
          <div class="control-group">
