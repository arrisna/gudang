...
<body>
    ...
    <br><br>
    <form class="form-inline" method="post" action="<?php echo base_url().'penjualan/cari'; ?>">
    
    Cari Penjualan : <input type="text" class="form-control" id="penjualan" placeholder="masukkan nama penjualan" name="cari">
    <button type="submit" class="btn btn-default" name="submit">Submit</button>
    <a  href="<?php echo site_url("penjualan"); ?>/tambah" class="btn btn-success">Tambah Data</a>
    </form>
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              foreach($penjualan as $row):
                ...
                echo '<td>Rp. '.$total.'</td>';
                echo '<td width=90px>'; ?>
                <?php echo anchor('penjualan/update/'.$row['no_penjualan'],'Lihat & Edit',array('class' => 'btn btn-info')); ?>
                <?php echo '</td>
                <td width=60px>'; ?>
                <?php echo anchor('penjualan/hapus/'.$row['no_penjualan'],'Hapus',array('onclick'=>'return confirm(\'Apakah Anda Yakin?\');', 'class' => 'btn btn-danger')); ?>
                <?php echo '</td>';
                echo '</tr>';
              endforeach;
              ?>      
